...
export default Component.extend({
  ...
  decoratedGraph: computed(
    ...
    'completeWorkflowGraph',
    {
      get() {
        const showDownstreamTriggers =
                    this.showDownstreamTriggers === undefined ? false : this.showDownstreamTriggers;
                const builds = get(this, 'builds') === undefined ? [] : get(this, 'builds');
                const { startFrom } = this;
                const jobs = get(this, 'jobs') === undefined ? [] : get(this, 'jobs');
                const workflowGraph =
                    get(this, 'workflowGraph') === undefined ? { nodes: [], edges: [] } : get(this, 'workflowGraph');
                const completeGraph =
                    get(this, 'completeWorkflowGraph') === undefined
                        ? {
                              nodes: [],
                              edges: []
    ...
    async draw(data) {
        ...
        const isSkipped = get(this, 'isSkipped') === undefined ? false : get(this, 'isSkipped');
