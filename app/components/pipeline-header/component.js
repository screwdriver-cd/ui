...
export default Component.extend({
  ...
  sonarBadgeName: computed(
    'pipeline.badges.sonar.{defaultName,name}',
    'this.pipeline.badges.sonar.{ defaultName,name}',
    {
      get() {
  ...
  sonarBadgeUri: computed(
    'pipeline.badges.sonar.{defaultUri,uri}',
    'this.pipeline.badges.sonar.{ defaultUri,uri}',
    {
      get() {
