...
moduleForComponent('sd-build-step-container', 'Integration | Component | sd build step container', {
  integration: true,
...
test('it renders', function (assert) {
  ...
  this.render(hbs`{{sd-build-step-container build=buildMock step=stepMock}}`);
